...
def ping(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text(f"🏓 TOTT\n<b>TOTT:</b> {ping_time}s\n<b>TOTT:</b> {uptime}", parse_mode=ParseMode.HTML)

@run_async
def uptime(bot: Bot, update: Update):
	uptime = get_readable_time((time.time() - StartTime))
	update.effective_message.reply_text(f"TOTT: {uptime}")    
